...
<div className="bg-surface border-b border-border/50 px-4 py-3">
  <p className="text-center text-sm text-text-secondary">
    🎨 Free plan: <span className="text-gold font-semibold">{Math.max(0, remainingGenerations)} of {WEEKLY_LIMIT} designs remaining</span> this week. Resets every 7 days.
            ...
            >
              <p>You've used all <strong>{WEEKLY_LIMIT} free designs</strong> for this week. Your allowance resets every 7 days.</p>
              <p className="pt-2 text-sm text-text-secondary">Come back next week for more free designs, or stay tuned — we'll be introducing an unlimited plan soon!</p>
            </Modal>
